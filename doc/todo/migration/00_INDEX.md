...
| F | 🟡 Kısmi | F1 PostureSystem + F2 BossBrain (saf, Flame'siz unit testli; seedli Rng boss'ta paylaşılır) + F6 BossView (render→presentation) çıkarıldı. boss.dart 1681→1442 sat. analyze temiz, 141 test yeşil (22 yeni). game.actionSystem invariant'ı korundu. **Kalan:** F3 resolver tamamlama, F4 deathblow, F5 state machine, F7 ~500 hedefi — ~30 ortak private alan paylaşan bağlı çekirdek; ayrı artışta. |
