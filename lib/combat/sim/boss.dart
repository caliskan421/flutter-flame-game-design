...
import 'package:boss_parry_arena/presentation/boss_view.dart';
import 'package:boss_parry_arena/combat/sim/projectile.dart';
...
part 'boss_state_machine.dart';
part 'deathblow_controller.dart';
part 'boss_combat.dart';
...
class Boss extends PositionComponent with HasGameReference<BossArenaGame> {
  ...
  void breakPosture() {
    ...
    game.bus.emit(
      PostureBreakFxRequested(_topCenter, color: _kAmber, scale: 1.4),
    );
